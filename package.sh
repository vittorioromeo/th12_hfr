...
cp build/dinput8.dll build/touhou_hfr.dll build/touhou_hfr.exe touhou_hfr.ini README.md ARCHITECTURE.md DEVNOTES.md DEVNOTES_RUNTIME.md MOD_COMPATIBILITY.md TH10_DEVNOTES.md TH11_DEVNOTES.md TH13_DEVNOTES.md ADDING_A_GAME.md TH11_README.md TH12_README.md RESOLUTION.md install.ps1 "$P/touhou_hfr_v$V/"
...
cp build.sh build.ps1 package.sh package.ps1 test.sh test.ps1 test_th11.ps1 install.ps1 touhou_hfr.ini README.md ARCHITECTURE.md DEVNOTES.md DEVNOTES_RUNTIME.md MOD_COMPATIBILITY.md TH10_DEVNOTES.md TH11_DEVNOTES.md TH13_DEVNOTES.md ADDING_A_GAME.md TH11_README.md TH12_README.md RESOLUTION.md "$P/touhou_hfr_v$V/source/"
