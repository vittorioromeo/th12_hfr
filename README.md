...
TH15's engine three games on, ported the same way and at the same level: display-rate movement
for bullets, the player, her shots, items and lasers; sub-tick input; interpolated enemies and
