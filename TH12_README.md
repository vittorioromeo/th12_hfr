...
**Touhou 11:** an initial v1.00a port is available in this branch. See
[TH11_README.md](TH11_README.md) for its installation and validation status,
and [TH11_DEVNOTES.md](TH11_DEVNOTES.md) for the engine mapping. TH12's code and
existing build scripts are unchanged.
