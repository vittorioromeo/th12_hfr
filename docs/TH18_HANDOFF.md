...
No disk game code has been patched. Sub-tick gameplay disabled; 3D camera/non-quad lasers
are not smoothed yet. Default interpolation on, prediction off.
...
- No hardware game test has been performed.
...
1. Await user's TH18 playtest: F11 menu, F10/window/fullscreen, stage movement/shots,
...
3. Smooth non-quad lasers and 3D background. Gameplay sub-stepping requires a separate
